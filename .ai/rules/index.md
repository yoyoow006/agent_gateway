...
| agent_gateway | `cmd/agw/main.go`, `internal/`, `config/`, `.ai/kb/projects/agent_gateway.md` | agw、agent gateway、网关 | Go、LLM API 路由、Claude Code、Codex、供应商切换、failover、熔断、协议转换、虚拟令牌、项目档案、热重载 |
